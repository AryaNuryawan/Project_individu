    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <?php
          $kode_pasien = '';
          if (getSafeFormValue($show_pasien, 'kode') != '') {
            $kode_pasien = getSafeFormValue($show_pasien, 'kode');
          } else if ($latest_pasien && isset($latest_pasien['kode'])) {
            $kode_pasien = 'P' . str_pad((int)substr($latest_pasien['kode'], 1) + 1, 3, '0', STR_PAD_LEFT);
          } else {
            $kode_pasien = 'P001';
          }
          ?>
          <input type="text" class="form-control" id="kode" name="kode" value="<?= $kode_pasien ?>" required>
        </div>
        <div class="form-group">
